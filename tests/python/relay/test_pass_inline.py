...
def test_call_chain_inline_leaf():
    ...
    def get_mod():
        ...
        fn11 = fn11.set_attribute("Compiler", tvm.tir.StringImm("aa"))
        mod[g11] = fn11
...
def test_recursive_call_with_global():
    def get_mod():
        ...
        fn0 = fn0.set_attribute("Compiler", tvm.tir.StringImm("a"))
    ...
    def expected():
        ...
        with sb.else_scope():
            one_less = relay.subtract(i, relay.const(1, dtype='int32'))
            rec_call = relay.Call(sum_up, [one_less]) + fn0(i)
            sb.ret(relay.add(rec_call, i))
        func = relay.Function([i],
                              sb.get(),
                              ret_type=relay.TensorType([], 'int32'))
...
def test_globalvar_called_by_multiple_functions():
    ...
    def expected():
        ...
        x22 = relay.var("x22", shape=(3, 5))
        y22 = relay.var("y22", shape=(3, 5))
        fn22 = relay.Function([x22, y22], x22 - y22)
        fn22 = fn22.set_attribute("Compiler", tvm.tir.StringImm("b"))

        fn0 = relay.Function([x0, y0, z0], fn22(x0, y0) + z0)
        g0 = relay.GlobalVar("g0")
        mod[g0] = fn0
